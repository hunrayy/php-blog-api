<?php
    require(".././config.php");
    function insertContent($authorFirstName, $authorLastName, $authorEmail, $noteTitle, $noteContent){
        global $_conn;
        $getAdmin = "SELECT * FROM `admins` WHERE `firstname` = '$authorFirstName' AND `lastname` = '$authorLastName' AND `email` = '$authorEmail' AND `role_id` = 1";
